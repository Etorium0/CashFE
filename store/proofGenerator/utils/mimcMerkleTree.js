...
import { leBufferToBigint, hexToBigint } from './bigint.js'
...
async function mimicMerkleTree(leaves = []) {
  ...
  const mimcspongeMultiHash = (left, right) =>
    leBufferToBigint(pedersen.babyJub.F.fromMontgomery(mimcsponge.multiHash([left, right])))
